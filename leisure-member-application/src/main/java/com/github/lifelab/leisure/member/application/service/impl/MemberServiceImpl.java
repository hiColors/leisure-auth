...
import com.github.lifelab.leisure.member.application.entity.EMemberDetail;
import com.github.lifelab.leisure.member.application.entity.EMemberRole;
import com.github.lifelab.leisure.member.application.entity.ERole;
import com.github.lifelab.leisure.member.application.entity.value.EMemberDefaultValue;
import com.github.lifelab.leisure.member.application.repository.EMemberDetailRepository;
import com.github.lifelab.leisure.member.application.repository.EMemberRepository;
...
import com.github.lifelab.leisure.member.authorization.token.impl.MemberAuthorization;
...
import com.github.lifelab.leisure.member.model.resource.member.*;
import com.github.lifelab.leisure.member.model.resource.platform.Platform;
...
public class MemberServiceImpl implements MemberService {
    ...
    public Member modifyUsername(Long id, MemberUsernameModel model) {
        ...
        if (i != 1) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.MEMBER_MODIFY_FAIL);
        }
    ...
    public Member queryOne(String key, String keyType) {
        switch (keyType.toLowerCase()) {
            ...
            default:
                throw new LeisureMemberException(EnumExceptionMessageLeisureMember.MEMBER_QUERY_NON_SUPPORT);
        }
    }
    ...
    public void checkMobile(String mobile, Long id) {
        ...
        if (Objects.nonNull(eMember) && !eMember.getId().equals(id)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.MEMBER_MOBILE_EXIST);
        }
    }
    ...
    public void checkUsername(String username, Long id) {
        ...
        if (Objects.nonNull(eMember) && !eMember.getId().equals(id)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.MEMBER_USERNAME_EXIST);
        }
    }
    ...
    public void checkEmail(String email, Long id) {
        ...
        if (Objects.nonNull(eMember) && !eMember.getId().equals(id)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.MEMBER_EMAIL_EXIST);
        }
    }
