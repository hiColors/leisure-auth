...
import com.github.lifelab.leisure.member.application.entity.*;
import com.github.lifelab.leisure.member.application.entity.enums.EnumPlatformStatus;
import com.github.lifelab.leisure.member.application.repository.EPlatformJobRepository;
import com.github.lifelab.leisure.member.application.repository.EPlatformMemberRepository;
import com.github.lifelab.leisure.member.application.repository.EPlatformOrganizationRepository;
import com.github.lifelab.leisure.member.application.repository.EPlatformRepository;
import com.github.lifelab.leisure.member.application.service.MemberService;
import com.github.lifelab.leisure.member.application.service.PlatformService;
...
public class PlatformServiceImpl implements PlatformService {
    ...
    public Platform create(PlatformModel model) {
        ...
        if (Objects.isNull(member)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.MEMBER_NON_EXIST, "发起人通过 id 查询不存在");
        }
    ...
    public Platform modify(Long id, PlatformPatchModel model) {
        ...
        if (Objects.isNull(ePlatform)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.PLATFORM_NON_EXIST);
        }
    ...
    public void deleteOrganization(Long id, Long oid) {
        ...
        if (epo.getLevel().equals(0)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.PLATFORM_ORGANIZATION_ROOT_DENY_DELETE);
        } else if (!CollectionUtils.isEmpty(epo.getChildren())) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.PLATFORM_ORGANIZATION_CHILDREN_EXIST);
        } else if (memberRepository.existsByPlatformOrganizationIdAndPlatformId(oid, id)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.PLATFORM_ORGANIZATION_MEMBER_EXIST);
        } else {
    ...
    public void deleteJob(Long id, Long jid) {
        ...
        if (memberRepository.existsByPlatformJobIdAndPlatformId(jid, id)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.PLATFORM_JOB_MEMBER_EXIST);
        } else {
    ...
    public PlatformMember createMember(Long id, PlatformMemberModel model) {
        ...
        if (Objects.isNull(member)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.MEMBER_NON_EXIST);
        }
    ...
    public void checkPlatformName(String platformName, Long id) {
        ...
        if (Objects.nonNull(ePlatform) && !ePlatform.getId().equals(id)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.PLATFORM_NAME_EXIST);
        }
    }
    ...
    public void checkOrganizationAssociation(Long id, Long oid) {
        if (!organizationRepository.existsByIdAndPlatformId(oid, id)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.PLATFORM_ORGANIZATION_MISMATCHES);
        }
    }
    ...
    public void checkJobAssociation(Long id, Long jid) {
        if (!jobRepository.existsByIdAndPlatformId(jid, id)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.PLATFORM_JOB_MISMATCHES);
        }
    }
    ...
    public void checkMemberAssociation(Long id, Long pmid) {
        if (!memberRepository.existsByIdAndPlatformId(pmid, id)) {
            throw new LeisureMemberException(EnumExceptionMessageLeisureMember.PLATFORM_MEMBER_MISMATCHES);
        }
    }
