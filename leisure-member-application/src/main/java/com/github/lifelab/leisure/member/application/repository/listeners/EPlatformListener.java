package com.github.lifelab.leisure.member.application.repository.listeners;
...
import com.github.lifelab.leisure.member.application.repository.*;
    ...
    public void onPersist(PersistEvent event) throws HibernateException {
        if (event.getObject() instanceof EPlatform) {
            ...
            if (Objects.isNull(eRole)) {
                throw new LeisureMemberException(EnumExceptionMessageLeisureMember.ROLE_NON_EXIST, "平台发起人的默认角色不存在！");
            }
